...
app.listen('3000', function() {
    ...
    console.log(aerolineas.avionesPiloteadosPor('Emmanuel'));
...
const crearTripulantes1 = () => {
    ...
    const tripulante4 = new Tripulante('juan', 'inspector', 12);
    const tripulante5 = new Tripulante('pedro', 'inspector', 7);
...
const crearTripulantes2 = () => {
    const tripulante4 = new Tripulante('Emmanuel', 'Piloto', 25);
    const tripulante5 = new Tripulante('tripulante2', 'inspector', 15);
    const tripulante6 = new Tripulante('tripulante3', 'inspector', 5);
